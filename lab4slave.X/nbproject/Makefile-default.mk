...
SOURCEFILES_QUOTED_IF_SPACED=slave4.c SPI.c

# Object Files Quoted if spaced
OBJECTFILES_QUOTED_IF_SPACED=${OBJECTDIR}/slave4.p1 ${OBJECTDIR}/SPI.p1
POSSIBLE_DEPFILES=${OBJECTDIR}/slave4.p1.d ${OBJECTDIR}/SPI.p1.d

# Object Files
OBJECTFILES=${OBJECTDIR}/slave4.p1 ${OBJECTDIR}/SPI.p1

# Source Files
SOURCEFILES=slave4.c SPI.c
...
ifeq ($(TYPE_IMAGE), DEBUG_RUN)
${OBJECTDIR}/slave4.p1: slave4.c  nbproject/Makefile-${CND_CONF}.mk
	@${MKDIR} "${OBJECTDIR}" 
	@${RM} ${OBJECTDIR}/slave4.p1.d 
	@${RM} ${OBJECTDIR}/slave4.p1 
	${MP_CC} $(MP_EXTRA_CC_PRE) -mcpu=$(MP_PROCESSOR_OPTION) -c  -D__DEBUG=1  -fno-short-double -fno-short-float -O0 -fasmfile -maddrqual=ignore -xassembler-with-cpp -Wa,-a -DXPRJ_default=$(CND_CONF)  -msummary=-psect,-class,+mem,-hex,-file  -ginhx032 -Wl,--data-init -mno-keep-startup -mno-osccal -mno-resetbits -mno-save-resetbits -mno-download -mno-stackcall $(COMPARISON_BUILD)  -std=c99 -gdwarf-3 -mstack=compiled:auto:auto     -o ${OBJECTDIR}/slave4.p1 slave4.c 
	@${FIXDEPS} ${OBJECTDIR}/slave4.p1.d $(SILENT) -rsi ${MP_CC_DIR}../  
